...
def prepare_prompt(user_message: str, vectorData, conversational) -> str:
    ...
    Відповідай виключно українською мовою. Якщо інформації недостатньо, попроси уточнити запитання. Якщо інформація відсутня то скажи "Нажаль не маю інформації по вашому запитанню. Зателефонуйтте в ательє 097 65 38 200".
    ...
    Ательє Орхідея займається пошиттям і ремонтом одягу та прокатом костюмів. Девіз - досвід професійність та сервіс. Працює на ринку з 2002 року.
